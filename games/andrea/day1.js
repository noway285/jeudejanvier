...
const SOLUTIONS = {
    enigma1: 'MAUDEPACE',
    enigma2: '10-72-LP',
    enigma3: 'H3', // Badge position on grid
...
function showHint() {
    ...
    if (STATE.hintLevel === 1) {
        addPenalty(600); // 10 minutes
        display.innerHTML = `<p style="color:#ffb74d;">"Je suis un homme d'affaire, et le sang ça coûte trop cher."</p>`;
    } else if (STATE.hintLevel === 2) {
        addPenalty(900); // 15 minutes
...
function checkEnigma3() {
    ...
    if (input === 'H3' || input === 'I3' || input === 'H2' || input === 'I2') {
